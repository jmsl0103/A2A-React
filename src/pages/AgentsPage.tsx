        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            ...
            <div className="flex items-center gap-3">
              {/* Filters Button */}
              <button className="flex items-center gap-2 px-4 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white transition-all duration-200">
                <Filter size={18} />
              ...
              <div className="relative">
                <button className="flex items-center gap-2 px-4 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white transition-all duration-200 min-w-[140px] justify-between">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-white-900">{filteredAgents.length} agents found</h2>
              </div>
                  ...
                  <div key={agent.id} onClick={() => navigate(`/agent/${agent.id}`, { state: { agent } })}
                    ...
                    {agent.skills.length > 0 && (
                      <div className="flex flex-wrap gap-2 mb-4">
                        {[...new Set(agent.skills.flatMap((skill: any) => skill.name))].map((skill: any, index: number) => (
                          <span
                            key={index}
